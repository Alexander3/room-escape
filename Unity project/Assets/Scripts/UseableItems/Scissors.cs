...
public class Scissors : MonoBehaviour, Pickable
{
	[SerializeField]
	...
	public void Start()
	{
		...
		//_material.SetColor("_Color", HighlightColor * 0.01f);

		_originalMaterial = new Material(_material);

		_highlightedMaterial = new Material(_material);
		_highlightedMaterial.SetColor("_Color", HighlightColor * HighlightIntensity);
	}
